                ...
                for i in range(len(dialog_file)):
                    ...
                    if(tokens_list!=None):
                        ...
                        for t in range(len(tokens_list)):
                            sentence+=tokens_list[t]+" "
                        n=2
                        bigrams=ngrams(sentence.split(),n)
                        for grams in bigrams:
                            token1,token2=grams[0],grams[1]
                            tokens=token1+" "+token2
                            attribute_list.append("TOKEN_"+tokens)
                    else:
                    ...
                    if(pos_list!=None):
                        ...
                        for pos in range(len(pos_list)):
                            ...
                            pos_sentence+=pos_list[pos][1]+" "

                        bigrams=ngrams(pos_sentence.split(),n)
                        for grams in bigrams:
                            token1,token2=grams[0],grams[1]
                            tokens=token1+" "+token2
                            attribute_list.append("POS_"+tokens)
                    else:
